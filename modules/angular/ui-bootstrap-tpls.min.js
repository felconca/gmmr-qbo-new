 ...
 */ angular.module("ui.bootstrap", [
    ...
    function (a, b, c, d) {
      ...
      return {
        link: function (d, f, g) {
          function h() {
            (r = !!("horizontal" in g)),
              r ? ((s = { width: "" }), (t = { width: "0" })) : ((s = { height: "" }), (t = { height: "0" })),
              d.$eval(g.uibCollapse) ||
                f.addClass("show").addClass("collapse").attr("aria-expanded", !0).attr("aria-hidden", !1).css(s);
          }
          function i(a) {
            ...
            (f.hasClass("collapse") && f.hasClass("show")) ||
              b.resolve(n(d)).then(function () {
                f.removeClass("collapse").addClass("collapsing").attr("aria-expanded", !0).attr("aria-hidden", !1),
                  e
                    ? e(f, { addClass: "show", easing: "ease", css: { overflow: "hidden" }, to: i(f[0]) })
                        .start()
                        ["finally"](k)
                    : a.addClass(f, "show", { css: { overflow: "hidden" }, to: i(f[0]) }).then(k);
              }, angular.noop);
          }
          function k() {
            ...
            return f.hasClass("collapse") || f.hasClass("show")
              ? void b.resolve(p(d)).then(function () {
                  f
                    ...
                    .attr("aria-hidden", !0),
                    e
                      ? e(f, { removeClass: "show", to: t }).start()["finally"](m)
  ...
  angular
    ...
    .directive("uibAccordionGroup", function () {
      return {
        ...
        scope: { heading: "@", cardClass: "@?", isOpen: "=?", isDisabled: "=?" },
        controller: function () {
          ...
          if (j && j.length) {
            ...
            angular.isDate(e) && !isNaN(e.getTime())
              ...
              : (e && a.warn("dateparser:", "baseDate is not a valid date"),
                (m = { year: 1900, month: 0, date: 1, hours: 0, minutes: 0, seconds: 0, milliseconds: 0 }));
                ...
                a.$watch("datepickerOptions." + b, function (a) {
                  a
                    ? angular.isDate(a)
                      ...
                      : (j && g.warn("Literal date support has been deprecated, please switch to date object usage"),
                        (o[b] = new Date(h(a, "medium"))))
                    : (o[b] = i[b] ? l.fromTimezone(new Date(i[b]), q.getOption("timezone")) : null),
                    o.refreshView();
                });
                break;
              case "maxMode":
                  ...
                  ? a.$watch(
                      ...
                      function (c) {
                        (o[b] = a[b] = angular.isDefined(c) ? c : a.datepickerOptions[b]),
                          (("minMode" === b &&
                            o.modes.indexOf(a.datepickerOptions.datepickerMode) < o.modes.indexOf(o[b])) ||
                            ("maxMode" === b &&
                              o.modes.indexOf(a.datepickerOptions.datepickerMode) > o.modes.indexOf(o[b]))) &&
                            ((a.datepickerMode = o[b]), (a.datepickerOptions.datepickerMode = o[b]));
                      }
                    )
                  : (o[b] = a[b] = i[b] || null);
            }
          ...
          (this.init = function (b) {
            (p = b),
              ...
              a.datepickerOptions.initDate
                ? ((o.activeDate = l.fromTimezone(a.datepickerOptions.initDate, q.getOption("timezone")) || new Date()),
                  a.$watch("datepickerOptions.initDate", function (a) {
                    a &&
                      (p.$isEmpty(p.$modelValue) || p.$invalid) &&
                      ((o.activeDate = l.fromTimezone(a, q.getOption("timezone"))), o.refreshView());
                  }))
        ...
        (this.step = { months: 1 }),
          ...
          (this._refreshView = function () {
            ...
            if (((a.title = c(this.activeDate, this.formatDayTitle)), (a.rows = this.split(j, 7)), a.showWeeks)) {
              a.weekNumbers = [];
              for (var m = (11 - this.startingDay) % 7, n = a.rows.length, o = 0; o < n; o++)
    ...
    .controller("UibMonthpickerController", [
      ...
      function (a, b, c) {
        (this.step = { years: 1 }),
          ...
          (this._refreshView = function () {
            for (var b, d = new Array(12), e = this.activeDate.getFullYear(), f = 0; f < 12; f++)
    ...
    .controller("UibYearpickerController", [
      ...
      function (a, b, c) {
        ...
        (this.element = b),
          ...
          (this._refreshView = function () {
            for (var b, c = new Array(f), g = 0, h = d(this.activeDate.getFullYear()); g < f; g++)
              (b = new Date(this.activeDate)),
                b.setFullYear(h + g, 0, 1),
                (c[g] = angular.extend(this.createDateObject(b, this.formatYear), { uid: a.uniqueId + "-" + g }));
        ...
        position: function (c, d) {
          ...
          return (
            g !== a[0].documentElement &&
              ((h = this.offset(g)), (h.top += g.clientTop - g.scrollTop), (h.left += g.clientLeft - g.scrollLeft)),
            {
            ...
            if (
              ((d[0] =
                "top" === d[0] && q.height > o.top && q.height <= o.bottom
                  ? "bottom"
                  : "bottom" === d[0] && q.height > o.bottom && q.height <= o.top
                  ? "top"
                  ...
                  : d[0]),
              (d[1] =
                "top" === d[1] && q.height - m.height > o.bottom && q.height - m.height <= o.top
                  ? "bottom"
                  : "bottom" === d[1] && q.height - m.height > o.top && q.height - m.height <= o.bottom
                  ? "top"
                  : "left" === d[1] && q.width - m.width > o.right && q.width - m.width <= o.left
                  ? "right"
                  : "right" === d[1] && q.width - m.width > o.left && q.width - m.width <= o.right
                  ? "left"
                  : d[1]),
              "center" === d[1])
            )
              if (f.vertical.test(d[0])) {
                ...
                o.left + r < 0 && q.width - m.width <= o.right
                  ? (d[1] = "left")
                  : o.right + r < 0 && q.width - m.width <= o.left && (d[1] = "right");
              } else {
                var s = m.height / 2 - q.height / 2;
                o.top + s < 0 && q.height - m.height <= o.bottom
                  ? (d[1] = "top")
                  : o.bottom + s < 0 && q.height - m.height <= o.top && (d[1] = "bottom");
              }
          }
          switch (d[0]) {
            case "top":
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
        ...
        function s(a, b) {
          ...
          return (
            ...
            !d || !(!angular.isDate(d) || isNaN(d)) || (!!angular.isString(d) && !isNaN(q(d))))
          );
        }
        function t(c) {
              ...
              angular.forEach(["minDate", "maxDate"], function (b) {
                a.datepickerOptions[b]
                  ? angular.isDate(a.datepickerOptions[b])
                    ...
                    : (p && e.warn("Literal date support has been deprecated, please switch to date object usage"),
  ...
  angular
    ...
    .constant("uibDropdownConfig", { appendToOpenClass: "uib-dropdown-open", openClass: "show" })
        ...
        b.addClass("dropdown"),
          ...
          (p.focusDropdownEntry = function (a) {
            var c = o.dropdownMenu
              ...
              : b.find("div").eq(0).find("a.");
            switch (a) {
              case 40:
                angular.isNumber(o.selectedOption)
                  ? (o.selectedOption = o.selectedOption === c.length - 1 ? o.selectedOption : o.selectedOption + 1)
                  : (o.selectedOption = 0);
                break;
              case 38:
                angular.isNumber(o.selectedOption)
            ...
            if (
              ...
              if (
                ...
                (z.top = C.top - E.top + "px"),
                  A
                    ? (z.right = window.innerWidth - (C.left - E.left + b.prop("offsetWidth")) + "px")
  ...
  angular
        ...
        return {
          ...
          link: function (e, f, g) {
            f.addClass(g.windowTopClass || ""),
              (e.size = g.size),
              (e.scrollable = "true" === g.scrollable),
              (e.close = function (b) {
                var c = a.getTop();
                c &&
                  c.value.backdrop &&
              ...
              function () {
                ...
                d.toggleClass(b, e),
                  !e &&
                    ...
                    v.heightOverflow &&
                    v.scrollbarWidth &&
                    (v.originalRight ? d.css({ paddingRight: v.originalRight + "px" }) : d.css({ paddingRight: "" }),
                    (v = null)),
                  n(!0);
              },
              c.closedDeferred
            ...
            switch (a.which) {
              ...
              case 9:
                var c = z.loadFocusElementList(b),
                  d = !1;
                a.shiftKey
                  ? (z.isFocusInFirstItem(a, c) || z.isModalFocused(a, b)) && (d = z.focusLastFocusableElement(c))
    ...
    .provider("$uibModal", function () {
      var a = {
        options: { animation: !0, backdrop: !0, keyboard: !0, scrollable: !1 },
        $get: [
          "$rootScope",
          "$q",
          "$document",
          ...
          (b.setNumPages = d.numPages ? a(d.numPages).assign : angular.noop),
            ...
            (c.selectPage = function (a, d) {
              ...
              e &&
                ...
                a > 0 &&
                a <= c.totalPages &&
                (d && d.target && d.target.blur(), b.ngModelCtrl.$setViewValue(a), b.ngModelCtrl.$render());
            }),
              ...
              function (e, k, m, n) {
                ...
                var q = a(e),
                  ...
                  t =
                    ...
                    s +
                    '" ' +
                    (n.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + r + "content" + s + '" ') +
                  ...
                  compile: function (a, b) {
                    ...
                    return function (a, b, d, f) {
                      ...
                      var E,
                        ...
                        K,
                        L,
                        M = !!angular.isDefined(n.appendToBody) && n.appendToBody,
                        N = p(void 0),
                              ...
                              (J = g(
                                function () {
                                  var a = i.parsePlacement(P.placement),
                                    c = i.positionElements(b, E, P.placement, M, !0),
                                    d = c.placement;
                                  E.hasClass(a[0]) || (E.removeClass(L.split("-")[0]), E.addClass(a[0])),
                                    E.hasClass(n.placementClassPrefix + d) ||
                                      (E.removeClass(n.placementClassPrefix + L),
                                      E.addClass(n.placementClassPrefix + d));
                                  var e = angular.isDefined(E.offsetHeight) ? E.offsetHeight : E.prop("offsetHeight"),
                                    f = M ? i.offset(b) : i.position(b);
                                  E.css({ top: c.top + "px", left: c.left + "px" }),
                                    (K = g(
                                      function () {
                                        var b = angular.isDefined(E.offsetHeight)
                                            ? E.offsetHeight
                                            : E.prop("offsetHeight"),
                                    ...
                                    E.hasClass("uib-position-measure")
                                      ? (i.positionArrow(E, c.placement), E.removeClass("uib-position-measure"))
                                      : L !== c.placement && i.positionArrow(E, c.placement),
                                    (L = c.placement),
                                    (J = null);
                                },
                                0,
      ...
      return {
        ...
        link: function (a, b, c) {
          (a.vertical = !!angular.isDefined(c.vertical) && a.$parent.$eval(c.vertical)),
            (a.justified = !!angular.isDefined(c.justified) && a.$parent.$eval(c.justified));
        },
      };
    })
    .directive("uibTab", [
      ...
      function (a, b, c, d, e, f, g) {
        ...
        c.secondStep &&
          ...
          (this.setupInputEvents = function (b, c, d) {
            if (a.readonlyInput)
              return (
                (a.updateHours = angular.noop), (a.updateMinutes = angular.noop), void (a.updateSeconds = angular.noop)
              );
            ...
            (a.updateHours = function () {
              ...
              x.$setDirty(),
                angular.isDefined(a) && angular.isDefined(b)
                  ? (v.setHours(a), v.setMinutes(b), v < C || v > D ? e(!0) : l("h"))
                  : e(!0);
            }),
              ...
              (a.updateMinutes = function () {
                ...
                x.$setDirty(),
                  angular.isDefined(a) && angular.isDefined(b)
                    ? (v.setHours(b), v.setMinutes(a), v < C || v > D ? e(void 0, !0) : l("m"))
                    : e(void 0, !0);
              }),
          ...
          (this.render = function () {
            ...
            isNaN(b)
              ...
              : (b && (v = b),
                v < C || v > D ? (x.$setValidity("time", !1), (a.invalidHours = !0), (a.invalidMinutes = !0)) : m(),
                n());
          }),
                        ...
                        I &&
                          ...
                          (angular.isNumber(P.debounceUpdate) || angular.isObject(P.debounceUpdate)
                            ? k(
                                ...
                                angular.isNumber(P.debounceUpdate) ? P.debounceUpdate : P.debounceUpdate["default"]
                              )
                            : P.select(0, d)),
                        K)
                      ) {
                        var i = P.matches[0].label;
                        angular.isString(c) && c.length > 0 && i.slice(0, c.length).toUpperCase() === c.toUpperCase()
          ...
          (this.init = function (b) {
            (q = b),
              ...
              q.$parsers.unshift(function (b) {
                return (
                  (x = !0),
                  0 === u || (b && b.length >= u) ? (v > 0 ? (ba(), aa(b)) : Z(b)) : (z(a, !1), ba(), W()),
                  w ? b : b ? void q.$setValidity("editable", !1) : (q.$setValidity("editable", !0), null)
                );
              }),
