<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">InPatient Payments</h4>
    </div>
    ...
    <div class="w-50">
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            ...
            <div class="filter-input" style="width: 200px;">
                ...
                <select class="input-form" ng-model="filtered.types" ng-disabled="isFiltering || isSending">
            ...
            <button class="btn btn-theme-dark" ng-click="handleFilter(filtered, 'inpatients')"
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    ...
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (inpatientList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
