<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Walkin Payments</h4>
    </div>
    ...
    <div class="w-50">
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            <div class="filter-input" style="width: 145px;">
                <span>Status</span>
                <select class="input-form" ng-model="wfiltered.isBooked" ng-disabled="isFiltering || isSending">
            ...
            <div class="filter-input" style="width: 200px;">
                <span>Payment Types</span>
                <select class="input-form" ng-model="wfiltered.types" ng-disabled="isFiltering || isSending">
                    <option ng-value="-1" value="number:-1" selected="selected">All Payment Types</option>
                    <option ng-value="0" value="number:0">CASH</option>
                    <option ng-value="2" value="number:2">CREDIT CARD</option>
                    <option ng-value="3" value="number:3">DEBIT CARD</option>
                    <option ng-value="4" value="number:4">CHEQUE(s)</option>
                    <option ng-value="19" value="number:19">GCASH E-Wallet</option>
                    <option ng-value="20" value="number:20">PAYMAYA E-Wallet</option>
                    <option ng-value="22" value="number:22">Bank Transfer</option>
                </select>
            </div>
            <div class="filter-input" style="width: 150px;">
                <span>Date From:</span>
                <input type="date" class="input-form" ng-model="wfiltered.startDate" date-input ng-disabled="isFiltering || isSending">
            </div>
            <div class="filter-input" style="width: 150px;">
                <span>Date To:</span>
                <input type="date" class="input-form" ng-model="wfiltered.endDate" date-input ng-disabled="isFiltering || isSending">
            </div>
            <button class="btn btn-theme-dark" ng-click="handleFilter(wfiltered, 'walkin')"
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    ...
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (walkinList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showInvoiceModal(items.tranid)" ng-disabled="isSending">OR-{{items.refnum}}</a>
                </td>
                <td nowrap>{{items.tranid}}</td>
                <td nowrap>
