<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Credit Memo</h4>
    </div>
    ...
    <div class="w-50">
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            <div class="filter-input" style="width: 145px;">
                <span>Customer</span>
                <select class="input-form" ng-model="filtered.personType" ng-disabled="isFiltering || isSending">
                    <option ng-value="'all'">All Customer</option>
                    <option ng-value="'PATIENT'">Patient</option>
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (creditMemosList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showCreditModal(items.tranid)" ng-disabled="isSending">{{items.cmid}}</a>
                </td>
                <td nowrap>
                    ...
                    <div class="d-flex align-items-center" ng-if="items.pxid > 0">
                        ...
                        <small class="ms-2 status patient" ng-if="items.persontype == 'PATIENT' || items.persontype == 'Patient'">Patient</small>
                        <small class="ms-2 status employee" ng-if="['PATIENT','Patient','HMO','Corporate Acct','Health Facility','Assistance'].indexOf(items.persontype) === -1">Employee</small>
                    </div>
                </td>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="showCreditModal(items.tranid)">
