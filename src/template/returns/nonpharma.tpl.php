<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">NonPharma Returns</h4>
    </div>
    <div class="d-flex justify-content-end align-items-center">
        <div class="d-flex align-items-center" style="gap:10px">
            ...
            <div class="d-flex align-items-center" style="gap:6px">
                <button class="btn btn-theme-dark" ng-click="handleBookItems(selectedItems, 'wgcentralsupply')" ng-disabled="selectedItems.length <= 0 || isSending">
                    <i class="ph-bold ph-share-fat me-1"></i>
                    Book/Re-Book
                </button>
                <button class="btn btn-danger text-white" ng-click="handleUnBookedItems(selectedItems, 'wgcentralsupply')" ng-disabled="selectedItems.length <= 0 || isSending">
...
<div class="d-flex align-items-end justify-content-between mt-3" style="gap:6px">
    ...
    <div class="w-50">
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            ...
            <button class="btn btn-theme-dark" ng-click="handleFilter(filtered, 'nonpharma')"
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (nonpharmaList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showCreditModal(items.tranid, 'wgcentralsupply')" ng-disabled="isSending">{{items.cmid}}</a>
                </td>
                <td nowrap>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="handleBookItems([items],'wgcentralsupply')">
                                    <i class="ph-bold ph-share-fat me-2"></i>Book/Re-Book
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="showCreditModal(items.tranid, 'wgcentralsupply')">
                                    <i class="ph-bold ph-pencil-line me-2"></i>GMMR Details
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="findCredit(items.sent_id)" ng-disabled="items.sent_id == 0">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center text-danger delete" type="button" ng-click="handleUnBookedItems([items],'wgcentralsupply')" ng-disabled="items.sent_id == 0">
...
<div class="d-flex align-items-center justify-content-between pt-3">
    ...
    <ul style="margin-bottom: 0 !important;" uib-pagination total-items="searched.length" num-pages="numPages" items-per-page="itemsPerPage" ng-model="currentPage" max-size="5" boundary-link-numbers="true" ng-change="changePage(creditMemosList)"></ul>
</div>