<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Pharmacy Returns</h4>
    </div>
    <div class="d-flex justify-content-end align-items-center">
        <div class="d-flex align-items-center" style="gap:10px">
            ...
            <div class="d-flex align-items-center" style="gap:6px">
                <button class="btn btn-theme-dark" ng-click="handleBookItems(selectedItems, 'wgfinance')" ng-disabled="selectedItems.length <= 0 || isSending">
        ...
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            ...
            <div class="filter-input" style="width: 260px;">
                ...
                <select class="input-form" ng-model="filtered.status" ng-disabled="isFiltering || isSending">
                    ...
                    <option ng-value="11">PHARMA/OPD RETURNS (walk in)</option>
                    <option ng-value="15">PHARMA RETURNS (in patient)</option>
                </select>
            </div>
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (pharmacyList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showCreditModal(items.tranid, 'wgfinance')" ng-disabled="isSending">{{items.cmid}}</a>
                </td>
                <td nowrap>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="handleBookItems([items],'wgfinance')">
                                    <i class="ph-bold ph-share-fat me-2"></i>Book/Re-Book
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="showCreditModal(items.tranid, 'wgfinance')">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center text-danger delete" type="button" ng-click="handleUnBookedItems([items],'wgfinance')" ng-disabled="items.sent_id == 0">
