<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Debit Memo</h4>
    </div>
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (debitMemosList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showDebitModal(items.tranid)" ng-disabled="isSending">{{items.tranid}}</a>
                </td>
                <td nowrap>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="findDebit(items.sent_id)" ng-disabled="items.sent_id == 0">
...
<div class="d-flex align-items-center justify-content-between pt-3">
    ...
    <ul style="margin-bottom: 0 !important;" uib-pagination total-items="searched.length" num-pages="numPages" items-per-page="itemsPerPage" ng-model="currentPage" max-size="5" boundary-link-numbers="true" ng-change="changePage(debitMemosList)"></ul>
</div>