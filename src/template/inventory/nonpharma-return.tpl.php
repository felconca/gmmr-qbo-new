<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Non-Pharma Return Inventory Cost</h4>
    </div>
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    ...
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (nonpharmaReturnList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showInvoiceModal(items.cmid)" ng-disabled="isSending">{{items.cmid}}</a>
                </td>
                <td nowrap>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center text-danger delete" type="button" ng-click="handleUnBookedItems([items], 'wgcentralsupply')"
                                    ng-disabled="items.cost_id == 0">
