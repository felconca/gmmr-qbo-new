<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Pharmacy Return Inventory Cost
        </h4>
    </div>
    <div class="d-flex justify-content-end align-items-center">
        <div class="d-flex align-items-center" style="gap:10px">
            ...
            <div class="d-flex align-items-center" style="gap:6px">
                <button class="btn btn-theme-dark" ng-click="handleBookReturnItems(selectedItems, 7, 'wgfinance')" ng-disabled="selectedItems.length <= 0 || isSending">
                    <i class="ph-bold ph-share-fat me-1"></i>
                    Book/Re-Book
                </button>
                <button class="btn btn-danger text-white" ng-click="handleUnBookedItems(selectedItems, 'wgfinance')" ng-disabled="selectedItems.length <= 0 || isSending">
    ...
    <div class="w-50">
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            <div class="filter-input" style="width: 145px;">
                <span>Status</span>
                <select class="input-form" ng-model="rfiltered.isBooked" ng-disabled="isFiltering || isSending">
            ...
            <div class="filter-input" style="width: 150px;">
                <span>Date From:</span>
                <input type="date" class="input-form" ng-model="rfiltered.startDate" date-input ng-disabled="isFiltering || isSending">
            </div>
            <div class="filter-input" style="width: 150px;">
                <span>Date To:</span>
                <input type="date" class="input-form" ng-model="rfiltered.endDate" date-input ng-disabled="isFiltering || isSending">
            </div>
            <button class="btn btn-theme-dark" ng-click="handleReturnFilter(rfiltered, 'pharma')"
...
<div class="table-cms mt-2" style="height: calc(100vh - 280px);">
    ...
    <table class="table align-middle mb-0 table-striped">
        ...
        <tbody>
            <tr ng-repeat="items in searched = (pharmacyReturnList | filter: search) | limitTo:itemsPerPage:itemsPerPage*(currentPage-1) track by $index">
                <td>
                ...
                <td nowrap>
                    <a class="link-anchor" ng-click="showInvoiceModal(items.tranid)" ng-disabled="isSending">{{items.cmid}}</a>
                </td>
                <td nowrap>
                ...
                <td nowrap class="text-end">{{items.netcost | number:2}}</td>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="handleBookReturnItems([items], 7, 'wgfinance')">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="findInvoice(items.cost_id)"
                                    ng-disabled="items.cost_id == 0">
                            ...
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center text-danger delete" type="button" ng-click="handleUnBookedItems([items], 'wgfinance')"
                                    ng-disabled="items.cost_id == 0">
...
<div class="d-flex align-items-center justify-content-between pt-3">
    ...
    <ul style="margin-bottom: 0 !important;" uib-pagination total-items="searched.length" num-pages="numPages" items-per-page="itemsPerPage"
        ng-model="currentPage" max-size="5" boundary-link-numbers="true" ng-change="changePage(pharmacyReturnList)"></ul>
</div>