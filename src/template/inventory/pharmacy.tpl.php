<div class="d-flex justify-content-between">
    <div>
        ...
        <h4 class="fw-semibold text-dark mb-0">Pharmacy Inventory Cost
        </h4>
    </div>
    <div class="d-flex justify-content-end align-items-center">
        <div class="d-flex align-items-center" style="gap:10px">
            ...
            <div class="d-flex align-items-center" style="gap:6px">
                <button class="btn btn-theme-dark" ng-click="handleBookItems(selectedItems, 7, 'wgfinance')" ng-disabled="selectedItems.length <= 0 || isSending">
        ...
        <div class="d-flex align-items-end justify-content-end" style="gap: 6px;">
            ...
            <div class="filter-input" style="width: 260px;">
                ...
                <select class="input-form" ng-model="filtered.status" ng-disabled="isFiltering || isSending">
                    ...
                    <option ng-value="10">PHARMACY (in patient)</option>
                    <option ng-value="12">PHARMACY (Charge To)</option>
                </select>
            </div>
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu btn-action">
                            <li>
                                <button class="dropdown-item py-2 d-flex align-items-center" type="button" ng-click="handleBookItems([items], 7, 'wgfinance')">
...
<div class="d-flex align-items-center justify-content-between pt-3">
    ...
    <ul style="margin-bottom: 0 !important;" uib-pagination total-items="searched.length" num-pages="numPages" items-per-page="itemsPerPage"
        ng-model="currentPage" max-size="5" boundary-link-numbers="true" ng-change="changePage(pharmacyList)"></ul>
</div>